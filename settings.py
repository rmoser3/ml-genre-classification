...
N_MFCC = 37 # number of mfcc coefficients per mfcc vector
N_FFT = 2048 # fft size
HOP_LENGTH = 256 # step size
NUM_SEGMENTS = 50 # number of segments per track
...
EPOCHS = 50 # for each epoch, the model trains on some number of training samples
